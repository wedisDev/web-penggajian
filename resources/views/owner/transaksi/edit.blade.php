...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('transaksi.update', $pegawai->id) }}" method="post">
                {{ method_field('PUT') }}
                @csrf
                <div class="form-group">
                    <label for="">ID Pegawai</label>
                    <input type="text" class="form-control" name="pegawai_id" id="id_pegawai" value="{{ $pegawai->id_pegawai }}">
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama" id="data_nama" value="{{ $pegawai->nama_pegawai }}"
                                readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="jabatan" id="data_jabatan"
                                value="{{ $pegawai->nama_jabatan }}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="status" id="data_status" value="{{ $pegawai->nama_golongan }}"
                                readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="jumlah_anak" id="data_jumlah_anak"
                                value="{{ $pegawai->jumlah_anak }}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bulan" id="bulan" value="{{ $pegawai->bulan }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="">Lembur</label>
                            <input type="text" class="form-control" name="lembur" id="lembur" value="{{ $pegawai->lembur }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pelanggaran" id="pelanggaran"
                                value="{{ $pegawai->pelanggaran }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Omzet</label>
                            <input type="text" name="id_pegawai" value="{{ $pegawai->id_pegawai }}" hidden>
                            <input type="text" class="form-control" name="omzet" id="jumlah_omzet" value="{{ $pegawai->omzet }}">
                        </div>
                    </div>
                </div>
